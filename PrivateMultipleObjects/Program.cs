...
namespace Inheritance
{
    ...
    class Moves : Pokemon
    {
        ...
        public override void addChange()
        {
            ...
            setMoveOne(Console.ReadLine());
            Console.Write("Move type=");
            setMoveType(Console.ReadLine());

        }
        public override void print()
        {
            base.print();
            Console.WriteLine($"     Move: {getMoveOne()}");
            Console.WriteLine($"Move type: {getMoveType()}");
            Console.WriteLine();
        }
    }
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!int.TryParse(Console.ReadLine(), out amtMoves))
                Console.WriteLine("Please enter a whole number");
            // array of Pokemon and Moves objects
